...
/**
 *
 * @author aless Questa classe rappresenta un'operazione di prodotto degli
...
public class DotCommand extends OperationCommand {
    ...
    /**
     * Il metodo execute esegue il prodotto tra l'ultimo e il penultimo elemento
     * presente nello stack.Se la dimensione dello stack è minore di 2,
     ...
     * richiama il metodo statico "dotOperation" della classe Operations.
     *
